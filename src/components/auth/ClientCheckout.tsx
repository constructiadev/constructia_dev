...
export default function ClientCheckout() {
  ...
  const handleSkipCheckout = () => {
    // CRITICAL: No permitir saltar checkout - es obligatorio
    if (confirm('⚠️ El checkout es obligatorio para activar tu cuenta. ¿Estás seguro de que quieres cancelar el registro?')) {
      navigate('/client-register', { replace: true });
    }
  };
