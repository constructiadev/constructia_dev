...
export default function DocumentUploadModal({ isOpen, onClose, onUploadComplete, sessionId }: DocumentUploadModalProps) {
  ...
  const handleUpload = async () => {
    if (!selectedClient || !selectedEmpresa || !selectedObra || selectedFiles.length === 0 || !selectedCategory) {
      alert('Por favor selecciona cliente, empresa, obra, categoría y al menos un archivo');
      return;
    }
  ...
  const canUpload = selectedClient && selectedEmpresa && selectedObra && selectedFiles.length > 0 && selectedCategory;
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
          ...
          {/* Category Selection */}
          {selectedClient && selectedEmpresa && selectedObra && (
          ...
          {/* File Upload Area */}
          {selectedClient && selectedEmpresa && selectedObra && selectedCategory && (
            <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          {(selectedClient || selectedEmpresa || selectedObra) && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <div className="text-sm text-blue-700">
                {selectedClient && (
                  <p>👤 Cliente: {clients.find(c => c.id === selectedClient)?.company_name}</p>
                )}
                {selectedEmpresa && (
