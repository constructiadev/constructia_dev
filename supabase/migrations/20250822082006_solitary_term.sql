/*
  # Complete ConstructIA Database Schema

  1. New Tables
    - `tenants` - Multi-tenant support
    - `users` - User management with roles
    - `empresas` - Companies in the new architecture
    - `obras` - Construction sites/projects
    - `proveedores` - Suppliers/contractors
    - `trabajadores` - Workers
    - `maquinaria` - Machinery/equipment
    - `documentos` - Documents in new architecture
    - `tareas` - Tasks and workflows
    - `requisitos_plataforma` - Platform requirements
    - `mapping_templates` - Data transformation templates
    - `adaptadores` - Platform adapters
...
-- Create documentos table (new architecture)
...
-- Create RLS policies for proveedores
...
-- Create RLS policies for trabajadores
...
-- Create RLS policies for maquinaria
...
-- Create RLS policies for tareas
...
-- Create RLS policies for requisitos_plataforma
...
-- Create RLS policies for mapping_templates
...
-- Create RLS policies for adaptadores
...
-- Create RLS policies for jobs_integracion
...
-- Create RLS policies for suscripciones
...
-- Create RLS policies for auditoria
...
-- Create RLS policies for mensajes
...
-- Create RLS policies for reportes
...
-- Create RLS policies for checkout_providers
...
-- Create RLS policies for mandatos_sepa
...
-- Create RLS policies for manual_upload_queue
